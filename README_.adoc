...
https://github.com/kazurayam/Processing50000/releases/[Releases] page.

This project was developed in order to propose a solution to a question raised at the Katalon User Forum:app-name: 

* https://forum.katalon.com/t/script-to-create-multiple-test-suites-clone-with-different-data-iteration/60724[Script to create multiple test suiites clone different data iteration]
...
I would not use Katalon's https://docs.katalon.com/katalon-studio/docs/ddt.html[Data-driven Testing] feature, because I want to control the data-variable binding myself.
...
link:data.csv[data.csv]

[quote]
----
include::./data.csv[lines=1..5]
...
include::./data.csv[lines=49995..50000]
----
...
link:Scripts/TC_worker/Script1639098728799.groovy[`Test Case /TC_worker`]

[quote]
----
include::Scripts/TC_worker/Script1639098728799.groovy[]
----
...
[quote]
----
include::Scripts/TC_controller/Script1639098742322.groovy[]
----
...
As https://docs.katalon.com/katalon-studio/docs/console-mode-execution.html#general-options[document] tells, Katalon Runtime Engine accepts command line arguments
...
[quote]
----
include::Scripts/TC_controller_filtering_data/Script1639121334993.groovy[]
----
